...
try:
    ...
    raise ImportError(
        f"Missing package: {missing_package}. Install dependencies with: "
        "pip install pandas openpyxl rapidfuzz python-Levenshtein SQLAlchemy scikit-learn "
        "sentence-transformers streamlit requests snowflake-sqlalchemy snowflake-connector-python"
    )
